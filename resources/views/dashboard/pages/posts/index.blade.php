                        ...
                        @foreach($posts as $post)
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img src="{{ asset('uploads/thumbnails/'.$post->thumbnail) }}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 5px;" alt="">
                                </td>
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $post->title }}</td>
                                <td class="px-4 py-3 text-center">{{ $post->category->name }}</td>
                                <td class="px-4 py-3 text-center">{{ $post->user->name }}</td>
                                <td class="px-4 py-3 text-center">{{ $post->created_at->format('d M Y') }}</td>
