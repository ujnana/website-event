...
@section('content')
                    ...
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <p class="text-base text-gray-500 dark:text-gray-400">{{ $article->user->getRoleNames()[0] }}</p>
                                <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate datetime="{{ $article->created_at}}" title="{{ $article->created_at->format('Y-m-d') }}">{{ $article->created_at->format('d M Y') }}</time></p>
                            </div>
                        </div>
                    </address>
    ...
    <aside aria-label="Related articles" class="py-8 px-8 lg:py-24 bg-gray-50 dark:bg-gray-800">
