            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button onclick="Livewire.dispatch('openModal', { component: 'users.create-user'})"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            <th style="width: 10%" scope="col" class="px-4 py-3">No.</th>
                            <th style="width: 30%" scope="col" class="px-4 py-3">Name</th>
                            <th style="width: 30%" scope="col" class="px-4 py-3">Email</th>
                            <th style="width: 15%" scope="col" class="px-4 py-3">Role</th>
                            <th style="width: 15%" scope="col" class="px-4 py-3 items-center text-center">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($users as $user)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $user->getRoleNames()[0] }}</td>
